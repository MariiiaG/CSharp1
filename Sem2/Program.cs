...
// Console.WriteLine($"{num} --> {result}"); // a better way, as it gives a single 
//                                    // number as a result. So we can work with it further
// Console.WriteLine($"{num} --> {num/100}{num%10}"); // will get two separate numbers as a result

// 2.напишите программу, кот принимает на входе 2 числа и определяет,
...
// 3. Напишите программу, которая на вход принимает число и проверяет, 
...
// 4. Напишите программу, которая на вход принимает два числа и проверяет, 
