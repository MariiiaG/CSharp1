// Задача 46 : Задайте двумерный массив размером m x n, заполненный случайными числами 
...
// и замените эти элементы на их квадраты. Чётные относительно пользователя, те начало индекса с 1
